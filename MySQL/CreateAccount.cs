    ...
    public partial class CreateAccountForm : Form
    {
        ...
        private void btnCreateAccount_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                MySqlCommand cmd1 = new MySqlCommand("SELECT * FROM nick.userinfo WHERE Username = @UserName", connection),
                cmd2 = new MySqlCommand("SELECT * FROM nick.userinfo WHERE Email = @UserEmail", connection);
                ...
                if (!(userExists || mailExists))
                {
                    ...
                    string iquery = "INSERT INTO nick.userinfo(`ID`,`FirstName`,`LastName`,`Gender`,`Birthday`,`Email`,`Username`, `Password`) VALUES (NULL, '" + txtFName.Text + "', '" + txtLName.Text + "', '" + cboGender.Text + "', '" + dateTimePicker1.Value.Date + "', '" + txtEmail.Text + "', '" + txtUsername.Text + "', '" + txtPassword.Text + "')";
